...
*******************************************************************************/
{include/i-prgvrs.i LAMC007A-SIMUL 2.00.00.007 } /*** 010007 ***/

&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
{include/i-license-manager.i lamc007a MLA}
&ENDIF
...
*                     estrutura antiga. SIMULACAO                             *
*-----------------------------------------------------------------------------*
*      VERSAO    DATA        RESPONSAVEL    MOTIVO                            *
*      D.00.000  10/05/1999  Nora           Desenvolvimento                   *
*      D.00.001  17/05/1999  Nora           Acerto montagem da carteira       *
*      D.00.002  20/05/1999  Leonardo       Troca variavel usuario.cd-unidade *
*                                                      por cd-unimed-par  *
