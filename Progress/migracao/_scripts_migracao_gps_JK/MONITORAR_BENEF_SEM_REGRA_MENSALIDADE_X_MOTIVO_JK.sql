...
select --count(*)
 ...
 'BENEFICIARIO DEVERIA TER REGRA DE MENSALIDADE. VERIFIQUE' MOTIVO
  from gp.usuario        ugp,
...
select --count(*)
 ...
 ib.log_respons,
 to_char(ib.cdcarteiraorigemresponsavel) CARTEIRA_RESPONSAVEL,
 'USUARIO.NRTABELA_CONTRATO ICOMPATIVEL COM SEU CONTRATO_DA_PESSOA' MOTIVO
  from gp.usuario        ugp,
       gp.import_bnfciar ib,
       gp.import_propost ip,
       usuario           us,
...
select --count(*)
 ...
 ib.log_respons,
 to_char(ib.cdcarteiraorigemresponsavel) CARTEIRA_RESPONSAVEL,
 'USUARIO.NRTABELA_CONTRATO ESTA NULO' MOTIVO
  from gp.usuario        ugp,
       gp.import_bnfciar ib,
       gp.import_propost ip,
       usuario           us,
