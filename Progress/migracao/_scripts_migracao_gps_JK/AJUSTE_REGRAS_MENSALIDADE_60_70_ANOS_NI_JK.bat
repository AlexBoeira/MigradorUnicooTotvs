...
set PROGRAMA=dep/de-corrige-faixa-etaria-60e70anos-regras-NI.p
set CLIENTLOG_NOME=C:\temp\corrige-regra-60e70-anos-NI
...
call %PROWIN32% -basekey "ini" -ininame %INI% -pf %PF% -p %PROGRAMA% %CLIENTLOG_CONF% %CLIENTLOG_NOME%_%DATA_HORA%
