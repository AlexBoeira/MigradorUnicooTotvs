...
if %FILA% leq %QT_FILAS_IMPORTACAO_GUIAS%  (
  call %PROWIN32% -basekey "ini" -ininame %INI% -pf %PF% -p %PROGRAMA% -param %FILA%,%EXECUTAR_CONTINUAMENTE% %CLIENTLOG_CONF% %CLIENTLOG_NOME%%FILA%_%DATA_HORA%
)
exit 0