        ...
        case in-status-benef-par:
            ...
            then do:
                   ...
                   THEN 
                        FOR EACH import-bnfciar
                           WHERE import-bnfciar.ind-sit-import = in-status-monitorar-par EXCLUSIVE-LOCK
                                 BREAK BY import-bnfciar.log-respons DESC
                                       BY import-bnfciar.cd-grau-parentesco:

                            message "Imp. Benef.Resp. Sit: " in-status-monitorar-par " " import-bnfciar.num-seqcial-bnfciar.
                            pause 0.
                   ...
                   ELSE 
                        FOR EACH import-bnfciar
                           WHERE import-bnfciar.ind-sit-import = in-status-monitorar-par EXCLUSIVE-LOCK:
                            ...
                            message "Imp. Benef.Dep. Sit: " in-status-monitorar-par " " import-bnfciar.num-seqcial-bnfciar.
                            pause 0.
            ...
            then do:
                   ...
                   THEN 
                        FOR EACH import-bnfciar
                           WHERE import-bnfciar.ind-sit-import    = in-status-monitorar-par
                             AND import-bnfciar.dt-exclusao-plano = ? EXCLUSIVE-LOCK
                                 BREAK BY import-bnfciar.log-respons DESC
                                       BY import-bnfciar.cd-grau-parentesco:
                        
                            message "Imp. Benef.Resp.ATIVOS Sit: " in-status-monitorar-par " " import-bnfciar.num-seqcial-bnfciar.
                            pause 0.
                   ...
                   ELSE 
                        FOR EACH import-bnfciar
                           WHERE import-bnfciar.ind-sit-import    = in-status-monitorar-par
                            ...
                            message "Imp. Benef.Dep.ATIVOS Sit: " in-status-monitorar-par " " import-bnfciar.num-seqcial-bnfciar.
                            pause 0.
                   ...
                   THEN 
                        FOR EACH import-bnfciar
                           WHERE import-bnfciar.ind-sit-import    = in-status-monitorar-par
                            ...
                            message "Imp. Benef.Resp.INATIVOS Sit: " in-status-monitorar-par " " import-bnfciar.num-seqcial-bnfciar.
                            pause 0.
                   ...
                   ELSE 
                        FOR EACH import-bnfciar
                           WHERE import-bnfciar.ind-sit-import    = in-status-monitorar-par
                            ...
                            message "Imp. Benef.Dep.INATIVOS Sit: " in-status-monitorar-par " " import-bnfciar.num-seqcial-bnfciar.
                            pause 0.
           ...
           then do:
                  ...
                  then do:
                         ...
                         then do:
                                ...
                                assign import-bnfciar.cd-registro-plano = 0.
           ...
           THEN DO:
                  ...
                  then if  year(import-bnfciar.dt-exclusao-plano) <>  0
                       then if  ter-ade.aa-ult-fat < import-bnfciar.aa-ult-fat-period
                            then do:
                                   assign lg-relat-erro = yes.
                                   RUN pi-cria-tt-erros("Ano ultimo faturamento MAIOR que o do TERMO").
                                 end.    
                            else.
                       else do:
                              assign lg-relat-erro = yes.
                              RUN pi-cria-tt-erros("Ano de referencia da ultima fatura invalida (TERMO)").
                            end.                                           
                END.
          ...
          for each tmp-mensa-rtapi041
             where tmp-mensa-rtapi041.in-tipo-mensagem = "E":
              ...
              RUN pi-cria-tt-erros(if tmp-mensa-rtapi041.ds-mensagem <> ?
                                   then "(rtapi041)" + tmp-mensa-rtapi041.ds-mensagem + " " + tmp-mensa-rtapi041.ds-complemento-mens + " " + tmp-mensa-rtapi041.ds-chave-mens
                                   else "").
          end.
        end.
       ...
       WHERE import-modul-bnfciar.num-seqcial-bnfciar = import-bnfciar.num-seqcial-bnfciar 
        ...
        ELSE DO:
               ...
               then do:
                      ...
                      RUN pi-cria-tt-erros("Data de cancelamento do Modulo nao pode ser superior ao cancelamento do beneficiario. Canc.Modulo: " + char-aux1 +
                                           " Canc.Benef: " + char-aux2).
               ...
               then do:
                      ...
                      RUN pi-cria-tt-erros("Data de cancelamento do Modulo do Beneficiario nao pode ser anterior a sua inclusao. Exclusao:  " +
                                           char-aux1 + " Inclusao: " + char-aux2).
        ...
        then do:
               ...
               then do:
                      ...
                      RUN pi-cria-tt-erros("Ano do faturamento do modulo (" + char-aux1 + ") menor que a data de inclusao do modulo(" + char-aux2 + ")").
               ...
               then do:
                      ...
                      RUN pi-cria-tt-erros("Mes do faturamento (" + char-aux1 + "/" + char-aux2 + ") do modulo (" + STRING(import-modul-bnfciar.cdn-modul) 
                                           + ") menor que a data de inclusao do modulo (" + char-aux1 + "/" + char-aux3 + ")").
               ...
               then do:
                      ...
                      RUN pi-cria-tt-erros("Data do faturamento (" + char-aux1 + "/" + char-aux3 
                                           + ") do modulo (" + STRING(import-modul-bnfciar.cdn-modul) 
                                           + ") difere da data do faturamento do beneficiario (" + char-aux2 + "/" + char-aux4 + ")").
