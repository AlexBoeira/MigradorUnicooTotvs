...
PROCEDURE cria-proposta:
    ...
    assign propost.cd-plano                   = b-import-propost.cd-plano
           ...
           propost.log-13                     = TRUE. /* permitir utilizar reajustes das regras de mensalidade */

    IF modalid.in-tipo-pessoa = "J"
    THEN propost.log-utiliz-lotac           = paravpmc.log-livre-26. /* indicador se utiliza lotacao */
