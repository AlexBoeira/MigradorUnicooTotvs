 ...
 *               .COD_LIVRE_1:  codigo do contrato no Unicoo (USUARIO.CDCONTRATO)
 *               .COD_LIVRE_2:  se tiver o valor 'A' indica que eh um registro de DEMITIDO/APOSENTADO e nao esta sendo usado o conceito de LOTACAO
 *               .COD_LIVRE_3:  carteira do responsavel, preenchido apenas quando o dependente eh gravado em plano separado, devido aos DEPARAS de estrutura
 *
 * IMPORT-MODUL-BNFCIAR.NUM-LIVRE-1: 
 */
