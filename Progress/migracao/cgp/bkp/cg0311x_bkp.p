...
PROCEDURE cria-proposta:
    ...
    then do:
           ...
           else for first reg-plano-saude fields(cod-plano-operadora idi-registro)
    ...
    if avail contrat
    then for first endereco fields (cd-cidade)
    ...
    FOR EACH import-faixa-propost FIELDS (cd-grau-parentesco nr-faixa-etaria num-idade-min num-idade-max qtd-fator-multiplic qtd-fator-multiplic-inscr)
       WHERE import-faixa-propost.num-seqcial-propost = b-import-propost.num-seqcial-propost NO-LOCK QUERY-TUNING (NO-INDEX-HINT):
        ...
        FOR FIRST teadgrpa FIELDS (nr-faixa-etaria)
            ...
            run pi-grava-erro ("Faixa Etaria Sobreposta - Tabela Importa‡Æo Grau: " + string(import-faixa-propost.cd-grau-parentesco,"99") + 
                               " Faixa: "       + string(import-faixa-propost.nr-faixa-etaria,"99")      + 
                               " Base - Grau: " + string(import-faixa-propost.cd-grau-parentesco,"99")   + 
                               " Faixa: "       + string(teadgrpa.nr-faixa-etaria,"99")).
            assign lg-relat-erro = yes.
        END.
