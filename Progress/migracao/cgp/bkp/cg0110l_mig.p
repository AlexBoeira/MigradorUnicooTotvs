  ...
  /* ------------------------------------------------------------------------ */
   ...
   case c-opcao:
      ...
      then do:
             ...
             then if   pipresta.lg-layout-serious              
                  then do:
...
/*                then run imprime-prestador. */
    ...
    /*                   tmp-preserv-aux.cd-registro-ans       = c-cd-registro-ans. */
               ...
               assign tmp-preserv-aux.log-18 = lg-publica-ans-aux.
    ...
    /*            else nr-seq-endereco-aux = 1.                           */
               ...
               assign tmp-endpres-aux.cd-unidade        = tmp-preserv-aux.cd-unidade   /* c-cd-unidade   */
                      ...
                      tmp-endpres-aux.en-endereco       = substring(c-dados,02,40)                                                         
                      tmp-endpres-aux.en-bairro         = substring(c-dados,42,15)                                                         
