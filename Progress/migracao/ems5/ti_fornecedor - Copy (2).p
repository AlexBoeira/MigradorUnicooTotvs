...
procedure busca_FORNECEDOR:
   ...
   then do:
          ...
          /*AND fornecedor.nom_pessoa = nom_pessoa_par
          AND fornecedor.cod_id_feder = cod_id_feder_par*/
          then do:                                           
                 assign cod_FORNECEDOR_par  = FORNECEDOR.cdn_FORNECEDOR
                        /*cod_id_feder_par = FORNECEDOR.cod_id_feder            RESPEITAR CPF/CNPJ DA TI_FORNECEDOR SEM SOBREPOR*/
