...
def new shared temp-table tt_integr_acr_lote_impl no-undo 
    ...
    field tta_ind_tip_cobr_acr             as character format "X(10)" initial "Normal" label "Tipo Cobranªa" column-label "Tipo Cobranªa" 
...
def new shared temp-table tt_log_erros_atualiz no-undo 
    ...
    field ttv_num_mensagem                 as integer format ">>>>,>>9" label "Nﬂmero" column-label "Nﬂmero Mensagem" 
...
def new shared temp-table tt_integr_acr_cheq no-undo 
    ...
    field tta_cod_motiv_devol_cheq         as character format "x(5)" label "Motivo Devoluªío" column-label "Motivo Devoluªío" 
    field tta_cod_indic_econ               as character format "x(8)" label "Moeda" column-label "Moeda" 
    field tta_cod_finalid_econ_ext         as character format "x(8)" label "Finalid Econ Externa" column-label "Finalidade Externa" 
...
def new shared temp-table tt_integr_acr_relacto_pend no-undo 
    ...
    field tta_ind_motiv_acerto_val         as character format "X(12)" initial "Alteraªío" label "Motivo Acerto Valor" column-label "Motivo Acerto Valor". 
