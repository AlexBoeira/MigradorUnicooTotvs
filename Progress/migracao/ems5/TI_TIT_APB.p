...
def temp-table tt_estorna_tit_imptos no-undo
    field ttv_cod_refer_imp            	as character format "x(10)" label "Referºncia" column-label "Referºncia"
    ...
    field ttv_ind_trans_ap_abrev     	as character format "X(04)" label "Transaªío" column-label "Transaªío"
    field ttv_cod_refer_2                  	as character format "x(10)" label "Referºncia" column-label "Referºncia"
