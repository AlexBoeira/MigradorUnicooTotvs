...
def new shared temp-table tt_integr_acr_lote_impl no-undo 
    ...
    field ttv_cod_empresa_ext              as character format "x(3)" label "CΩdigo Empresa Ext" column-label "CΩd Emp Ext" 
    ...
    field ttv_log_lote_impl_ok             as logical format "Sim/Nío" initial no 
    field tta_log_liquidac_autom           as logical format "Sim/Nío" initial no label "Liquidac Automˇtica" column-label "Liquidac Automˇtica" 
...
def new shared temp-table tt_integr_acr_item_lote_impl no-undo 
    ...
    field tta_cod_cartcred                 as character format "x(20)" label "C¢digo Cart∆o" column-label "C¢digo Cart∆o" 
    field tta_cod_mes_ano_valid_cartao     as character format "XX/XXXX" label "Validade Cart∆o" column-label "Validade Cart∆o" 
    field tta_cod_autoriz_cartao_cr        as character format "x(6)" label "C¢digo Autorizaá∆o" column-label "C¢digo Autorizaá∆o" 
...
def new shared temp-table tt_integr_acr_aprop_ctbl_pend no-undo 
    ...
    field tta_cod_unid_federac             as character format "x(3)" label "Unidade Federa?ío" column-label "UF" 
    field tta_log_impto_val_agreg          as logical format "Sim/Nío" initial no label "Impto Val Agreg" column-label "Imp Vl Agr" 
...
def new shared temp-table tt_integr_acr_abat_prev no-undo 
    ...
    field tta_log_zero_sdo_prev            as logical format "Sim/Nío" initial no label "Zera Saldo" column-label "Zera Saldo" 
    index tt_id                            is primary unique 
          ttv_rec_item_lote_impl_tit_acr   ascending 
          tta_cod_estab                    ascending 
          tta_cod_estab_ext                ascending 
...
def new shared temp-table tt_integr_acr_aprop_desp_rec no-undo 
    ...
    field tta_cod_tip_fluxo_financ         as character format "x(12)" label "Tipo Fluxo Financ" column-label "Tipo Fluxo Financ" 
    field tta_ind_tip_aprop_recta_despes   as character format "x(20)" label "Tipo ApropriaØ?o" column-label "Tipo ApropriaØ?o" 
    index tt_id                            is primary unique 
          ttv_rec_item_lote_impl_tit_acr   ascending 
          tta_cod_cta_ctbl_ext             ascending 
          tta_cod_sub_cta_ctbl_ext         ascending 
...
def new shared temp-table tt_integr_acr_cheq no-undo 
    field tta_cod_banco                    as character format "x(8)" label "Banco" column-label "Banco" 
    field tta_cod_agenc_bcia               as character format "x(10)" label "Ag?ncia Bancˇria" column-label "Ag?ncia Bancˇria" 
    ...
    field tta_dat_emis_cheq                as date format "99/99/9999" initial ? label "Data Emissío" column-label "Dt Emiss" 
    field tta_dat_depos_cheq_acr           as date format "99/99/9999" initial ? label "DepΩsito" column-label "DepΩsito" 
    field tta_dat_prev_depos_cheq_acr      as date format "99/99/9999" initial ? label "Previsío DepΩsito" column-label "Previsío DepΩsito" 
    ...
    field tta_cod_motiv_devol_cheq         as character format "x(5)" label "Motivo Devolu?ío" column-label "Motivo Devolu?ío" 
    field tta_cod_indic_econ               as character format "x(8)" label "Moeda" column-label "Moeda" 
    field tta_cod_finalid_econ_ext         as character format "x(8)" label "Finalid Econ Externa" column-label "Finalidade Externa" 
    field tta_cod_usuar_cheq_acr_terc      as character format "x(12)" label "Usuˇrio" column-label "Usuˇrio" 
    field tta_log_pend_cheq_acr            as logical format "Sim/Nío" initial no label "Cheque Pendente" column-label "Cheque Pendente" 
    field tta_log_cheq_terc                as logical format "Sim/Nío" initial no label "Cheque Terceiro" column-label "Cheque Terceiro" 
    field tta_log_cheq_acr_renegoc         as logical format "Sim/Nío" initial no label "Cheque Reneg" column-label "Cheque Reneg" 
    field tta_log_cheq_acr_devolv          as logical format "Sim/Nío" initial no label "Cheque Devolvido" column-label "Cheque Devolvido" 
...
def new shared temp-table tt_integr_acr_impto_impl_pend no-undo 
    ...
    field tta_cod_pais                     as character format "x(3)" label "Pas" column-label "Pas" 
    field tta_cod_pais_ext                 as character format "x(20)" label "Pas Externo" column-label "Pas Externo" 
    field tta_cod_unid_federac             as character format "x(3)" label "Unidade FederaØ?o" column-label "UF" 
    field tta_cod_imposto                  as character format "x(5)" label "Imposto" column-label "Imposto" 
    field tta_cod_classif_impto            as character format "x(05)" initial "00000" label "Class Imposto" column-label "Class Imposto" 
    ...
    field tta_cod_indic_econ               as character format "x(8)" label "Moeda" column-label "Moeda" 
    field tta_cod_finalid_econ_ext         as character format "x(8)" label "Finalid Econ Externa" column-label "Finalidade Externa" 
    field tta_val_cotac_indic_econ         as decimal format ">>>>,>>9.9999999999" decimals 10 initial 0 label "CotaØ?o" column-label "CotaØ?o" 
    field tta_dat_cotac_indic_econ         as date format "99/99/9999" initial ? label "Data CotaØ?o" column-label "Data CotaØ?o" 
...
def new shared temp-table tt_integr_acr_relacto_pend no-undo 
    ...
    field tta_log_gera_alter_val           as logical format "Sim/Nío" initial no label "Gera Alter Valor" column-label "Gera Alter Valor" 
    field tta_ind_motiv_acerto_val         as character format "X(12)" initial "Altera?ío" label "Motivo Acerto Valor" column-label "Motivo Acerto Valor". 
...
def new shared temp-table tt_integr_acr_repres_pend no-undo 
    field ttv_rec_item_lote_impl_tit_acr   as recid format ">>>>>>9" 
    field tta_cdn_repres                   as Integer format ">>>,>>9" initial 0 label "Representante" column-label "Representante" 
    field tta_val_perc_comis_repres        as decimal format ">>9.99" decimals 2 initial 0 label "% Comissío" column-label "% Comissío" 
...
def temp-table tt_integr_acr_liquidac_impto_2 no-undo
    ...
    field tta_dat_cotac_indic_econ         as date format "99/99/9999" initial ? label "Data Cota?ío" column-label "Data Cota?ío"
    field tta_val_cotac_indic_econ         as decimal format ">>>>,>>9.9999999999" decimals 10 initial 0 label "Cota?ío" column-label "Cota?ío"
...
def temp-table tt_integr_acr_liq_item_lote_3 no-undo
    ...
    field tta_dat_liquidac_tit_acr         as date format "99/99/9999" initial ? label "Liquida?ío" column-label "Liquida?ío"
    field tta_cod_autoriz_bco              as character format "x(8)" label "Autoriza?ío Bco" column-label "Autorizacao Bco"
    field tta_val_tit_acr                  as decimal format ">>>,>>>,>>9.99" decimals 2 initial 0 label "Valor" column-label "Valor"
    field tta_val_liquidac_tit_acr         as decimal format ">>>,>>>,>>9.99" decimals 2 initial 0 label "Vl Liquida?ío" column-label "Vl Liquida?ío"
    ...
    field tta_ind_sit_item_lote_liquidac   as character format "X(09)" initial "Gerado" label "Situa?ío Item Lote" column-label "Situa?ío Item Lote"
    ...
    field tta_val_cotac_indic_econ         as decimal format ">>>>,>>9.9999999999" decimals 10 initial 0 label "Cota?ío" column-label "Cota?ío"
    field tta_ind_tip_calc_juros           as character format "x(10)" initial "Simples" label "Tipo C lculo Juros" column-label "Tipo C lculo Juros"
    field tta_log_retenc_impto_liq         as logical format "Sim/Nío" initial no label "Ret?m na Liquida?ío" column-label "Ret na Liq"
...
for each ti_tit_acr where ti_tit_acr.CDSITUACAO = in-status-par /* AND TI_TIT_ACR.val_ir = 0*/ no-lock ,
   first b2_ti_controle_integracao where b2_ti_controle_integracao.nrsequencial = ti_tit_acr.nrseq_controle_integracao no-lock:
    ...
    THEN DO:
           ...
           THEN RUN escrever-log("@@@@@P2 NAO CONSEGUIU ACESSAR B_TI_TIT_ACR PARA ATUALIZAR CDSITUACAO!!!!!").
           ELSE do:
                  RUN escrever-log("@@@@@setando b_ti_tit_acr.CDSITUACAO = CA pois o titulo ja foi migrado anteriormente").
                  assign b_ti_tit_acr.CDSITUACAO = "CA".
                  RUN escrever-log("@@@@@vai fazer VALIDATE B_TI_TIT_ACR P3").
                  VALIDATE b_ti_tit_acr.
                  RUN escrever-log("@@@@@vai fazer RELEASE B_TI_TIT_ACR P3").
                  RELEASE  b_ti_tit_acr.
                  RUN escrever-log("@@@@@TERMINOU RELEASE B_TI_TIT_ACR P3").
                END.
         END.
    ELSE DO:
           IF v_conta >= 50 
        ...
        */
        ...
        FOR EACH tt_log_erros_import_liquidac:
            ...
            create TI_FALHA_DE_PROCESSO. 
              ...
              TI_FALHA_DE_PROCESSO.TXFALHA = "Erro na Atualiza?ío do Lote de Liquida?ío"
