...
*      Empresa ......: DZSET SOLUCOES E SISTEMAS LTDA.                       *
*      Programador ..: Monia Regina Turella                                  *
*      Objetivo .....: Include de definicao API de titulo EMS 5.04           *
******************************************************************************
*      VERSAO    DATA        RESPONSAVEL    MOTIVO                           *
*      E.00.000  18/04/2001  Monia          Desenvolvimento                  *
*****************************************************************************/
...
def new shared temp-table tt_integr_acr_impto_impl_pend no-undo 
    ...
    field tta_cod_pais_ext                 as character format "x(20)" label "Paðs Externo" column-label "Paðs Externo" 
