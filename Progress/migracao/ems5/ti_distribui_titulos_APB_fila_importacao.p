/**
 * Varrer todos os ti_tit_apb e trocar a situacao RC para R0, R1, R2... ate R9
 */
...
for each ti_tit_apb where ti_tit_apb.cdsituacao = "RC" exclusive-lock:

    assign ti_tit_apb.cdsituacao = proximo-status-titulo().
