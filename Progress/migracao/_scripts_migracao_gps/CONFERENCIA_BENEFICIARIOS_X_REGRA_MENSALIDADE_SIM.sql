--ESSE SCRIPT VALIDA A TABELA DE SIMULAÇÃO DAS REGRAS DE MENSALIDADE. PARA VALIDAR NA BASE OFICIAL, UTILIZAR O OUTRO SCRIPT SEM '_SIM' NO FINAL DO NOME.
