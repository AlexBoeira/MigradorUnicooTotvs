...
HEAD "<TITLE>STATUS_IMPORTACAO_TITULOS_A_PAGAR</TITLE> -
<link rel='stylesheet' type='text/css' href='&2'> -
" -
TABLE "WIDTH='90%' BORDER='1'"

SPOOL &1\TITULO_APB\STATUS_IMPORTACAO_TITULOS_A_PAGAR.html

-- MONITORAR STATUS
select decode(cdsituacao,'IT','INTEGRADO','RC','NA FILA PARA IMPORTAR',
	          'CA','CANCELADO','PE','ERRO IMPORTACAO NO TOTVS',
			  'PE','ERRO IMPORTACAO NO TOTVS',cdsituacao) SIT_MIG, count(*) QTD, sysdate || ' ' || to_char(systimestamp, 'HH24:MI:ss') ULT_ATU
