-- MONITORAR STATUS IMPORTACAO TITULOS ACR
select tpintegracao, decode(cdacao,'F','FECHADO','ABERTO') SIT_TIT, cdsituacao, count(*), SYSDATE
  from ti_controle_integracao           where tpintegracao in('TR','BR')
