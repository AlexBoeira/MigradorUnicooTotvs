...
start %PROWIN32% -basekey "ini" -ininame %INI% -pf %PF% -p %PROGRAMA% -param R6,%USUARIO%,%SENHA% %CLIENTLOG_CONF% %CLIENTLOG_NOME%_6.txt.
start %PROWIN32% -basekey "ini" -ininame %INI% -pf %PF% -p %PROGRAMA% -param R7,%USUARIO%,%SENHA% %CLIENTLOG_CONF% %CLIENTLOG_NOME%_7.txt.
start %PROWIN32% -basekey "ini" -ininame %INI% -pf %PF% -p %PROGRAMA% -param R8,%USUARIO%,%SENHA% %CLIENTLOG_CONF% %CLIENTLOG_NOME%_8.txt.
start %PROWIN32% -basekey "ini" -ininame %INI% -pf %PF% -p %PROGRAMA% -param R9,%USUARIO%,%SENHA% %CLIENTLOG_CONF% %CLIENTLOG_NOME%_9.txt.
